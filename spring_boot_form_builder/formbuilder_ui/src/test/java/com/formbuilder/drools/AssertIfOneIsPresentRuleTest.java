...
public class AssertIfOneIsPresentRuleTest {
	...
	private static Logger logger = Logger.getLogger(AssertIfOneIsPresentRuleTest.class);
	String inputs;
	Rule ruleObj;
	String ruleString = "assertIfOneIsPresent";
