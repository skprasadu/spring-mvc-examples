...
public class DynamicController {
	...
	public JSONObject saveForm(@RequestBody JSONObject input, @RequestParam("app_name") String appName, @RequestParam("formid") String formId, @RequestParam("dataid") int dataId)
